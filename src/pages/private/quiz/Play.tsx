...
class Play extends React.Component<{}, State> {
    ...
    handleDisabledButton = () => {
        ...
        if (this.state.prevQuestion === undefined || this.state.currentQuestionIdx === 0) {
            this.setState({
                prevBtnDisabled: true
            })
        } else {
        ...
        // Disable Next Button
        if (this.state.nextQuestion === undefined || this.state.currentQuestionIdx + 1 === this.state.numOfQuestions) {
            this.setState({
